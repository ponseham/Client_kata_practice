...
describe('Book Store', () => {
    ...
    test("Display quantities of books and pricing summary when adding two sets of books", async () => {
    ...
    test("Show price with discount when adding multiple sets of books", async () => {
