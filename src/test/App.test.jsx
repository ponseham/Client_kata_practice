...
describe('Book Store', () => {
    ...
    test("Display book quantities and pricing summary when adding multiple copies of books", async () => {
    ...
    test("Adjust basket item quantity when adding and removing copies of a book", async () => {
