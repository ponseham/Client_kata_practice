...
export const THREE_BOOK_WITH_DISCOUNT_TOTAL = '150.00'
export const THREE_BOOK_WITH_DISCOUNT_SUBTOTAL = '135.00'
export const THREE_BOOK_WITH_DISCOUNT_DISCOUNT = '-15.00'
export const FOUR_BOOK_WITH_DISCOUNT_TOTAL = '200.00'
export const FOUR_BOOK_WITH_DISCOUNT_SUBTOTAL = '160.00'
export const FOUR_BOOK_WITH_DISCOUNT_DISCOUNT = '-40.00'
export const FIVE_BOOK_WITH_DISCOUNT_TOTAL = '250.00'
export const FIVE_BOOK_WITH_DISCOUNT_SUBTOTAL = '187.50'
