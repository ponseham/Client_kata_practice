...
export const EIGHT_BOOKS_WITH_DISCOUNT_TOTAL = '320.00'
export const EIGHT_BOOKS_WITH_DISCOUNT_SUBTOTAL = '400.00'
export const EIGHT_BOOKS_WITH_DISCOUNT_DISCOUNT = '-80.00'